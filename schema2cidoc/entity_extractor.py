...
- person: Individual people (people names, historical figures, mentioned people)
  Examples: Willem van Boudelo, Jacob van Maerlant, Reinaertdichter (the nickname for the author of the poem Van den Vos Reynaerde)
...
- theory: a mentioned scholarly theory
  Examples: Chaucerian theory, medievalism, postcolonialism, feminism
...
- material: a mentioned material
  Examples: parchment, paper, wood, stone


INSTRUCTIONS:
1. Extract ALL relevant entities from the text content
2. For each entity, provide the exact name as it appears
3. Classify each entity into one of the ten types above
...
def main():
    ...
    metadata_file = args.metadata_file or os.path.join(base_dir, "input.json")
